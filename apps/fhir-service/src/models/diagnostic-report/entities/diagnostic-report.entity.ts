...
/** TypeORM Entity for the diagnostic_report table. */
/**
 * TypeORM Entity for the `diagnostic_report` table.
 *
 * This class maps directly to the database table structure that Liquibase
 * creates. It represents the *current, active version* of a DiagnosticReport
 * resource. This table is optimized for fast reads and direct lookups of the
 * latest state of a diagnostic report.
 */
@Entity('diagnostic_report')
@Index('idx_diagnostic_report_txid', ['txid'])
// Functional indexes for common FHIR search parameters - TypeORM approach
export class DiagnosticReport {
    /**
     * Unique identifier for the resource (e.g. DiagnosticReport/12345).
    ...
    /**
     * The DiagnosticReport resource itself, serialized as JSONB.
     */
