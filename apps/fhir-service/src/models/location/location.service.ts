...
/**
 * Concrete service for the Location resource.
 * 
 * This service is responsible for handling all business logic related to Location resources.
 ...
 * here lean, consistent, and focused on Location-specific configurations.
 */
@Injectable()
export class LocationService extends GenericFhirService<Location, LocationHistory> {
     ...
     */
    protected readonly resourceType = 'Location';

    /**
     * The constructor injects all necessary dependencies.
     * @param repo The TypeORM repository for the `Location` entity (the current table).
     * @param historyRepo The TypeORM repository for the `LocationHistory` entity.
    ...
    constructor(
        ...
        protected readonly repo: Repository<Location>,

        @InjectRepository(LocationHistory)
        protected readonly historyRepo: Repository<LocationHistory>,
        ...
        // with the Location and LocationHistory tables.
