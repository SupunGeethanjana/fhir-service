...
export class Medication {
    /**
     * Unique identifier for the resource (e.g. Medication/12345).
    ...
    /**
     * The Medication resource itself, serialized as JSONB.
     */
