...
/**
 * TypeORM Entity for the `organization` table.
 *
 * This class maps directly to the database table structure that Liquibase
 * creates. It represents the *current, active version* of an Organization
 * resource. This table is optimized for fast reads and direct lookups of the
 * latest state of an organization.
 */
@Entity('organization')
@Index('idx_organization_txid', ['txid'])
// Functional indexes for common FHIR search parameters - TypeORM approach
export class Organization {
    /**
     * Unique identifier for the resource (e.g. Organization/12345).
    ...
    /**
     * The Organization resource itself, serialized as JSONB.
     */
