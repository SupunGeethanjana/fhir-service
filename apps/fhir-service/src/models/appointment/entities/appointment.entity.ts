...
/**
 * TypeORM Entity for the `appointment` table.
 *
 * This class maps directly to the database table structure that Liquibase
 * creates. It represents the *current, active version* of an Appointment
 * resource. This table is optimized for fast reads and direct lookups of the
 * latest state of an appointment.
 */
@Entity('appointment')
@Index('idx_appointment_txid', ['txid'])
// Functional indexes for common FHIR search parameters - TypeORM approach
export class Appointment {
    /**
     * Unique identifier for the resource (e.g. Appointment/12345).
    ...
    /**
     * The Appointment resource itself, serialized as JSONB.
     */
