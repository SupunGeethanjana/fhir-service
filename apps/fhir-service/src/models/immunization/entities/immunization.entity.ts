...
/**
 * TypeORM Entity for the `immunization` table.
 *
 * This class maps directly to the database table structure that Liquibase
 * creates. It represents the *current, active version* of an Immunization
 * resource. This table is optimized for fast reads and direct lookups of the
 * latest state of an immunization.
 */
@Entity('immunization')
@Index('idx_immunization_txid', ['txid'])
export class Immunization {

    /**
     * Unique identifier for the resource (e.g. Immunization/12345).
    ...
    /**
     * The Immunization resource itself, serialized as JSONB.
     */
