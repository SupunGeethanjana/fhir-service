...
// See functional_indexes.sql for: idx_observation_component_gin
export class Observation {
    /**
     * Unique identifier for the resource (e.g. Observation/12345).
    ...
    /**
     * The Observation resource itself, serialized as JSONB.
     */
