...
@Entity('explanation_of_benefit_history')
@Index('idx_explanation_of_benefit_history_id', ['id'])
@Index('idx_explanation_of_benefit_history_txid', ['txid'])
export class ExplanationOfBenefitHistory {
