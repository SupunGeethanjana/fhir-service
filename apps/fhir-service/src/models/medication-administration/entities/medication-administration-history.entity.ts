...
@Entity('medication_administration_history')
@Index('idx_medication_administration_history_id', ['id'])
@Index('idx_medication_administration_history_txid', ['txid'])
export class MedicationAdministrationHistory {
