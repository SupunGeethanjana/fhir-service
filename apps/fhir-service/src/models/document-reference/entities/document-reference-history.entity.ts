...
@Entity('document_reference_history')
@Index('idx_document_reference_history_id', ['id'])
@Index('idx_document_reference_history_txid', ['txid'])
export class DocumentReferenceHistory {
